...
class BPE(object):
    ...
    def __init__(self, codes, merges=-1, separator='##', vocab=None, glossaries=None):
        ...
        self.bpe_codes = [tuple(item.split()) for (n, item) in enumerate(codes) if ((n < merges or merges == -1) and len(item.split()) == 2)]
